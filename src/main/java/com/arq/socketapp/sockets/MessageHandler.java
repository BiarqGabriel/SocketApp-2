...
public class MessageHandler {
    ...
    /**
     * Construct a MessageHandler that contains information about the router and
     * the package name for the Message objects.
     *
    ...
    /**
     * Construct a MessageHandler that contains the package name for message
    ...
    /**
     * Returns the MessageReader associated with the formatname of a
     * MessageRecord
     *
     ...
     *
     * @return an empty instance of the specified concrete subclass of
     * MessageRecord.
     *
     ...
     * default input for this MessageHandler.
     *
    ...
    /**
     * Releases the MessageRouter from this MessageHandler Sets this
     * MessageHandler's MessageRouter to null
     *
     ...
     *
     * @param messagerouter a MessageRouter to be used for sending and receiving
     * messages.
     *
     * @exception IOException
     */
     ...
     *
     * @return the name of the package containing the message classes for this
     * MessageHandler.
     */
